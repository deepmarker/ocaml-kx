...
type trade = { sym : string; side : char; size : int64; price : float }
[@@deriving sexp]
...
let pp_trade ppf t = Format.fprintf ppf "%a" Sexplib.Sexp.pp (sexp_of_trade t)
...
let () =
  Command.async ~summary:"Feed subscriber"
